 ...
 * as a dependency within your angular app. The other modules are for org purposes.
 *
 * The modules are:
...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
  ...
  function $get(   $rootScope,   $q,   $view,   $injector,   $resolve,   $stateParams,   $urlRouter,   $location,   $urlMatcherFactory) {
    ...
    // Handles the case where a state which is the file of a transition is not found, and the user
 ...
 *
 * Will activate when the ui-sref's file state or any child state is active. If you
 * need to activate only when the ui-sref file state is active and *not* any of
 ...
 * when the exact file state used in the `ui-sref` is active; no child states.
 *
 */
